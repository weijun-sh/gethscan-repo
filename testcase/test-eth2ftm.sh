...
# in
# swapin
../build/bin/gethscan scanswap --config config-eth.toml --gateway https://nodes.mewapi.io/rpc/eth --start 13530367 --end 13530368
...
# mint
../build/bin/gethscan scanswap --config config-ftm.toml --gateway https://rpc.ftm.tools --start 20733233 --end 20733234
...
# out
# burn
../build/bin/gethscan scanswap --config config-ftm.toml --gateway https://rpc.ftm.tools --start 20735918 --end 20735919
...
# swapout
../build/bin/gethscan scanswap --config config-eth.toml --gateway https://nodes.mewapi.io/rpc/eth --start 13530554 --end 13530555
